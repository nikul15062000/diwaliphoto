...
public class diwali_InternalStorageContentProvider extends ContentProvider {
	...
	public ParcelFileDescriptor openFile(Uri uri, String mode) throws FileNotFoundException {
		File f = new File(getContext().getFilesDir(), diwali_ImageViewActivity.TEMP_PHOTO_FILE_NAME);
		if (f.exists()) {
