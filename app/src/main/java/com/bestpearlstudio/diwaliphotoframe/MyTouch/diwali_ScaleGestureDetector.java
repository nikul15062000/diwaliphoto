 ...
 * </ul>
 */
public class diwali_ScaleGestureDetector {
     ...
     * <ul>
     *  <li>One {@link OnScaleGestureListener#onScaleBegin(diwali_ScaleGestureDetector)}
     *  <li>Zero or more {@link OnScaleGestureListener#onScale(diwali_ScaleGestureDetector)}
     *  <li>One {@link OnScaleGestureListener#onScaleEnd(diwali_ScaleGestureDetector)}
     * </ul>
     */
    public interface OnScaleGestureListener {
         ...
         * pointers going up.
         *
         * Once a scale has ended, {@link diwali_ScaleGestureDetector#getFocusX()}
         * and {@link diwali_ScaleGestureDetector#getFocusY()} will return the location
         * of the pointer remaining on the screen.
         *
         * @param detector The detector reporting the event - use this to
         *          retrieve extended info about event state.
         */
        public void onScaleEnd(View view, diwali_ScaleGestureDetector detector);
    }
     ...
     * {@link OnScaleGestureListener#onScale(diwali_ScaleGestureDetector)} returns
     * {@code false} so that a subclass can retrieve the accumulated scale
     * factor in an overridden onScaleEnd.
     * {@link OnScaleGestureListener#onScaleBegin(diwali_ScaleGestureDetector)} returns
     * {@code true}.
     */
    ...
    private diwali_Vector2D mCurrSpanVector;
    ...
    public diwali_ScaleGestureDetector(OnScaleGestureListener listener) {
        mListener = listener;
        mCurrSpanVector = new diwali_Vector2D();
    }
    ...
    public diwali_Vector2D getCurrentSpanVector() {
